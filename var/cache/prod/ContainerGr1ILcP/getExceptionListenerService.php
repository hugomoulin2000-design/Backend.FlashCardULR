...
class getExceptionListenerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \EasyCorp\Bundle\EasyAdminBundle\EventListener\ExceptionListener(false, ($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Provider\\AdminContextProvider'] ?? self::getAdminContextProviderService($container)), $a, ($container->privates['logger'] ?? self::getLoggerService($container)));
