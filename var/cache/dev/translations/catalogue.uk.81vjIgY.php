...
$catalogue = new MessageCatalogue('uk', array (
  ...
  array (
    ...
    'action.toggle_dropdown' => 'Перемкнути випадаюче меню',
    ...
    'action_confirmation_modal.title' => 'Ви впевнені, що хочете %action_name%?',
    'action_confirmation_modal.action' => 'Підтвердити',
    ...
    'exception.general' => 'Під час обробки вашого запиту сталася помилка.',
    'exception.general_403' => 'У вас немає дозволу на виконання цієї дії.',
    'exception.general_404' => 'Запитувану сторінку не знайдено.',
    'exception.general_500' => 'Під час обробки вашого запиту сталася внутрішня помилка.',
