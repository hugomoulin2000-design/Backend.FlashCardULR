...
$catalogue = new MessageCatalogue('el', array (
  ...
  array (
    ...
    'action.toggle_dropdown' => 'Εναλλαγή αναπτυσσόμενου μενού',
    ...
    'action_confirmation_modal.title' => 'Είστε σίγουροι ότι θέλετε να %action_name%;',
    'action_confirmation_modal.action' => 'Επιβεβαίωση',
    'filter.title' => 'Φίλτρα',
    ...
    'filter.label.contains_all' => 'περιέχει όλα',
    ...
    'exception.general' => 'Παρουσιάστηκε σφάλμα κατά την επεξεργασία του αιτήματός σας.',
    'exception.general_403' => 'Δεν έχετε δικαίωμα να εκτελέσετε αυτήν την ενέργεια.',
    'exception.general_404' => 'Η σελίδα που ζητήθηκε δεν βρέθηκε.',
    'exception.general_500' => 'Παρουσιάστηκε εσωτερικό σφάλμα κατά την επεξεργασία του αιτήματός σας.',
