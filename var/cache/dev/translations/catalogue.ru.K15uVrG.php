...
$catalogue = new MessageCatalogue('ru', array (
  ...
  array (
    ...
    'action.toggle_dropdown' => 'Переключить выпадающее меню',
    ...
    'action_confirmation_modal.title' => 'Вы уверены, что хотите %action_name%?',
    'action_confirmation_modal.action' => 'Подтвердить',
    ...
    'exception.general' => 'При обработке вашего запроса произошла ошибка.',
    'exception.general_403' => 'У вас недостаточно прав для выполнения этого действия.',
    'exception.general_404' => 'Запрашиваемая страница не найдена.',
    'exception.general_500' => 'При обработке вашего запроса произошла внутренняя ошибка.',
    'autocomplete.no-results-found' => 'Совпадений не найдено',
    'autocomplete.no-more-results' => 'Нет больше результатов',
