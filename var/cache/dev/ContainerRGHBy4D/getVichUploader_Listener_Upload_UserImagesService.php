 ...
 */
class getVichUploader_Listener_Upload_UserImagesService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.upload.user_images'])) {
            return $container->privates['vich_uploader.listener.upload.user_images'];
        }

        $instance = new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('user_images', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? $container->load('getVichUploader_MetadataReaderService')), $a);

        if (isset($container->privates['vich_uploader.listener.upload.user_images'])) {
            return $container->privates['vich_uploader.listener.upload.user_images'];
        }

        return $container->privates['vich_uploader.listener.upload.user_images'] = $instance;
    }
}
