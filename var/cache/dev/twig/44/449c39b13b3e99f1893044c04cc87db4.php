...
class __TwigTemplate_390af3537d45dbcec75a2813a14fd2b2 extends Template
{
    ...
    public function block_vich_file_widget(array $context, array $blocks = []): iterable
    {
        ...
        if ((($tmp = (isset($context["download_uri"]) || array_key_exists("download_uri", $context) ? $context["download_uri"] : (function () { throw new RuntimeError('Variable "download_uri" does not exist.', 16, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            ...
            yield "\" download>
                ";
            // line 18
            yield ((((isset($context["download_label_translation_domain"]) || array_key_exists("download_label_translation_domain", $context) ? $context["download_label_translation_domain"] : (function () { throw new RuntimeError('Variable "download_label_translation_domain" does not exist.', 18, $this->source); })()) === false)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["download_label"]) || array_key_exists("download_label", $context) ? $context["download_label"] : (function () { throw new RuntimeError('Variable "download_label" does not exist.', 18, $this->source); })()), "html", null, true)) : ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans((isset($context["download_label"]) || array_key_exists("download_label", $context) ? $context["download_label"] : (function () { throw new RuntimeError('Variable "download_label" does not exist.', 18, $this->source); })()), [], (isset($context["download_label_translation_domain"]) || array_key_exists("download_label_translation_domain", $context) ? $context["download_label_translation_domain"] : (function () { throw new RuntimeError('Variable "download_label_translation_domain" does not exist.', 18, $this->source); })())), "html", null, true)));
            yield "
            </a>";
        }
        // line 21
    ...
    public function block_vich_image_widget(array $context, array $blocks = []): iterable
    {
        ...
        if ((($tmp = (isset($context["download_uri"]) || array_key_exists("download_uri", $context) ? $context["download_uri"] : (function () { throw new RuntimeError('Variable "download_uri" does not exist.', 44, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            ...
            yield "\" download>
                ";
            // line 46
            yield ((((isset($context["download_label_translation_domain"]) || array_key_exists("download_label_translation_domain", $context) ? $context["download_label_translation_domain"] : (function () { throw new RuntimeError('Variable "download_label_translation_domain" does not exist.', 46, $this->source); })()) === false)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["download_label"]) || array_key_exists("download_label", $context) ? $context["download_label"] : (function () { throw new RuntimeError('Variable "download_label" does not exist.', 46, $this->source); })()), "html", null, true)) : ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans((isset($context["download_label"]) || array_key_exists("download_label", $context) ? $context["download_label"] : (function () { throw new RuntimeError('Variable "download_label" does not exist.', 46, $this->source); })()), [], (isset($context["download_label_translation_domain"]) || array_key_exists("download_label_translation_domain", $context) ? $context["download_label_translation_domain"] : (function () { throw new RuntimeError('Variable "download_label_translation_domain" does not exist.', 46, $this->source); })())), "html", null, true)));
            yield "
            </a>";
        }
        // line 49
    ...
    {
        return array (  195 => 49,  190 => 46,  185 => 45,  183 => 44,  178 => 41,  173 => 40,  171 => 39,  168 => 36,  166 => 35,  164 => 34,  161 => 32,  159 => 31,  157 => 30,  147 => 29,  139 => 26,  137 => 25,  127 => 24,  119 => 21,  114 => 18,  109 => 17,  107 => 16,  104 => 13,  102 => 12,  100 => 11,  97 => 9,  95 => 8,  93 => 7,  83 => 6,  75 => 3,  73 => 2,  63 => 1,  55 => 29,  53 => 24,  51 => 6,  49 => 1,);
    }
...
{%- endblock -%}
", "@VichUploader/Form/fields.html.twig", "/var/www/projets/projetl2/vendor/vich/uploader-bundle/templates/Form/fields.html.twig");
    }
}
