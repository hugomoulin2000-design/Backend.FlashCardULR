...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected static function getDoctrine_Dbal_DefaultConnection_EventManagerService($container)
    {
        ...
        ]), [[['preUpdate'], 'vich_uploader.listener.clean.deck_images'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_token_provider_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.pdo_session_handler_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.lock_store_schema_listener'], [['loadClassMetadata'], 'doctrine.orm.default_listeners.attach_entity_listeners'], [['preRemove'], 'vich_uploader.listener.remove.deck_images'], [['postFlush'], 'vich_uploader.listener.remove.deck_images'], [['prePersist'], 'vich_uploader.listener.upload.deck_images'], [['preUpdate'], 'vich_uploader.listener.upload.deck_images']]);
